...
public class OpenApiResource {
	...
	public Response get(@Context Application app) throws Exception {
		...
		SwaggerConfiguration cfg = new SwaggerConfiguration().openAPI(new OpenAPI())
				.resourcePackages(Set.of("org.eclipse.rest")).prettyPrint(true);

		var ctx = new JaxrsOpenApiContextBuilder().application(app).openApiConfiguration(cfg).buildContext(true);
