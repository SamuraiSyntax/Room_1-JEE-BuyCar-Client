        ...
        >
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="login-tab"
                    data-bs-toggle="tab"
                    data-bs-target="#login-tab-pane" type="button"
                    role="tab" aria-controls="login-tab-pane"
                    aria-selected="true"
                >Connexion</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="register-tab"
                    data-bs-toggle="tab"
                    data-bs-target="#register-tab-pane" type="button"
                    role="tab" aria-controls="register-tab-pane"
                    aria-selected="false"
                >Inscription</button>
            </li>
        </ul>
        <div class="tab-content" id="authTabsContent">
            ...
            >
                <form action="${pageContext.request.contextPath}/connexion" method="post" class="p-4 border rounded shadow-sm bg-light w-50 mx-auto">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        > <label for="motDePasseConnexion">Mot
                            de passe</label>
                    </div>
            ...
            >
                <form
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control"
                            id="emailInscription" name="email"
                    ...
                    <div class="form-floating mb-3">
                        <input type="password" class="form-control"
                            ...
                            placeholder="Mot de passe" required
                        > <label for="motDePasseInscription">Mot
                            de passe</label>
                    </div>
