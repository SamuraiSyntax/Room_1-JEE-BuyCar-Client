    ...
    <main class="container mt-5">
        ...
        <div class="tab-content" id="authTabsContent">
            <div class="tab-pane fade show active" id="login-tab-pane" role="tabpanel" aria-labelledby="login-tab" tabindex="0">
                <form action="${pageContext.request.contextPath}/connexion" method="post" class="p-4 border rounded shadow-sm bg-light w-50 mx-auto">
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" id="emailConnexion" name="email"
                            value="${param.email != null ? param.email : (email != null ? email : '')}" placeholder="Email" required
                        > <label for="emailConnexion">Email</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="password" class="form-control" id="motDePasseConnexion" name="motDePasse" placeholder="Mot de passe" required>
            ...
            <div class="tab-pane fade" id="register-tab-pane" role="tabpanel" aria-labelledby="register-tab" tabindex="0">
                <form action="${pageContext.request.contextPath}/inscription" method="post" class="p-4 border rounded shadow-sm bg-light w-50 mx-auto">
                    <div class="row g-3 mb-3">
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="nom" name="nom" value="${param.nom != null ? param.nom : ''}"
                        ...
                        <div class="col">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="prenom" name="prenom" value="${param.prenom != null ? param.prenom : ''}"
                    ...
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" id="emailInscription" name="email" value="${param.email != null ? param.email : ''}"
                            placeholder="Email" required
                        > <label for="emailInscription">Email</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="password" class="form-control" id="motDePasseInscription" name="motDePasse" placeholder="Mot de passe" required>
