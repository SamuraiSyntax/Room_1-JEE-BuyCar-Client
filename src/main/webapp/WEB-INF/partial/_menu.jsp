<nav
	...
	<div class="container-fluid">
		<a class="navbar-brand fw-bold d-flex gap-2 align-items-center"
			href="${pageContext.request.contextPath}/accueil"><i
			class="fa-solid fa-car-side"></i><span>BuyCar</span></a>
					...
					<c:when test="${not empty sessionScope.utilisateur}">
						...
						<li class="nav-item dropdown"><a
							...
							aria-expanded="false"><i
								class="fa-solid fa-user"></i><span>${sessionScope.utilisateur.prenom}</span>
						</a>
							<ul class="dropdown-menu dropdown-menu-end">
								<li><span
									class="dropdown-item-text text-muted d-flex gap-2 align-items-center"><i
										class="fa-solid fa-envelope"></i><span>${sessionScope.utilisateur.email}</span></span></li>
								<li><hr class="dropdown-divider"></li>
								<li><a class="dropdown-item text-danger"
									href="${pageContext.request.contextPath}/deconnexion"><i
